  ...
  const locations: Location[] = [
    {
      ...
      coordinates: [44.616, 33.525],
      count: 10
    },
    {
      name: "ТСН Афганец",
      address: "г. Севастополь, ТСН Афганец",
      coordinates: [44.588, 33.478],
      count: 17
    },
    {
      name: "ТСН Милосердие",
      address: "г. Севастополь, ТСН Милосердие",
      coordinates: [44.610, 33.540],
      count: 6
    },
    {
      name: "ТСН Поиск",
      address: "г. Севастополь, ТСН Поиск",
      coordinates: [44.595, 33.495],
      count: 4
    },
    {
      name: "ТСН Царское Село",
      address: "г. Севастополь, ТСН Царское Село",
      coordinates: [44.605, 33.515],
      count: 3
    },
    {
      name: "Орловка, Полюшко",
      address: "пос. Орловка, Полюшко",
      coordinates: [44.690, 33.365],
      count: 1
    }
  ];
